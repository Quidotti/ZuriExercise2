...
<body>
    <div class="wrapper">
        ...
        <div class="container">
            <form action="config/config-edit.php" method="POST">
                <h1><a href="addCourse.php">Edit a Course</a></h1>
                <hr>
                ...
                <div class="form-group">
                    Course Code
                    <input class="form-control" type="text" name="c_code" value="<?php echo $rows['course_code'] ?>">
				</div>
					<div class="form-group">
						Course Title<input class="form-control" type="text" name="c_title" value="<?php echo $rows['course_title'] ?>">
						
					</div>


                    <div class="form-group">
						<!-- Course Title<input class="form-control" type="text" name="id" value="<?php echo $rows['id'] ?>"> -->
